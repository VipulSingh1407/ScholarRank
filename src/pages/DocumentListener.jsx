...
import documentListenerImage from '../assets/loading.png'; // Replace with actual path
...
const DocumentListenerPage = () => {
  return (
    <>
      <div className="container mx-auto  p-4 flex flex-col items-center justify-center">
        {/* Main Heading Section */}
        <h1 className="text-4xl font-bold pt-[5.25rem] mb-8 w-full text-center">Document Listener</h1>
        <div className="lg:flex lg:items-center lg:justify-center w-full mb-16">
          <div className="lg:w-1/2 w-full lg:pr-8">
            <h2 className="text-2xl font-semibold mb-4">Listen to your Documents</h2>
            <p className="mb-6">
          ...
          <div className="lg:w-1/2 w-full lg:pl-8 mt-8 lg:mt-0 flex justify-center">
            <img
              src={documentListenerImage}
              alt="Document Listener"
        ...
        <div className="w-full text-center mb-16">
          ...
          <p className="text-lg text-gray-600">Explore the powerful features that make Document Listener unique and efficient.</p>
        </div>
...
export default DocumentListenerPage;
