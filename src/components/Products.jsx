    ...
    <div className="container md:pb-10">
      ...
      <div className="relative grid gap-6 md:grid-cols-2 md:gap-4 md:pb-[7rem]">
        {roadmap.map((item) => {
          ...
          return (
            <div
              className={`md:flex even:md:translate-y-[7rem] p-0.25 rounded-[2.5rem] transition duration-300 ${
            ...
            >
              <div className="relative p-8 bg-n-8 rounded-[2.4375rem] overflow-hidden xl:p-15">
                ...
                <div className="relative z-1">
                  ...
                  <div className="mt-4">
                    <CTAButton active={false} linkto={item.url} className="w-40">
                      Try Now!
                    </CTAButton>
                  </div>
                </div>
